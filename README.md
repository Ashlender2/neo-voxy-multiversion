...
|---|---|---|---:|---|
| Minecraft 1.21.1 · NeoForge | 客户端必装，服务端可选 | Sodium 0.8.x / Iris 1.8.12+ | 21 | `neo-voxy-0.5.0-alpha.1-mc1.21.1-neoforge.jar` |
| Minecraft 1.20.1 · Forge | 仅客户端 | Embeddium / Oculus | 17 | `neo-voxy-0.3.5-alpha.1-mc1.20.1-forge-client.jar` |
